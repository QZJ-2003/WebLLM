...
MODEL_INFOS = [
    ...
    { "model_name": "deepseek-r1-distill-qwen-32b", "label": "蒸馏版，深度推理", "order": 5 },
    { "model_name": "qwen2.5-32b-instruct", "label": "性能均衡", "order": 6 },
    { "model_name": "deepseek-r1", "label": "满血版r1，深度推理", "order": 7 },
    { "model_name": "qwen2.5-coder-32b-instruct", "label": "代码专家", "order": 8 },
